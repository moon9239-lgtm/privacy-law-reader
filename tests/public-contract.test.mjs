...
test("visitor summary keeps the previous desktop text treatment", async () => {
  ...
  assert.match(styles, /\.header-meta-row \{ position: absolute; top: 4px; right: 10px; left: auto; width: 148px; justify-content: center; gap: 0; \}/);
...
test("reader keeps the public visitor summary connected", async () => {
  ...
  assert.match(styles, /\.header-meta-row \{ position: absolute; top: 4px; right: 10px; left: auto; width: 148px; justify-content: center;/);
